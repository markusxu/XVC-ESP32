/*
   ...
   History:
    This work, "main.cpp", is a derivative of "xvc-esp32.ino" (https://github.com/derekmulcahy/xvcpi)
    by Haoze Li.

    "main.cpp" is licensed under CC0 1.0 Universal (http://creativecommons.org/publicdomain/zero/1.0/)
    by Derek Mulcahy.
...
static const char *MY_SSID = "your_wifi_ssid";
static const char *MY_PASSPHRASE = "your_wifi_passworld";
